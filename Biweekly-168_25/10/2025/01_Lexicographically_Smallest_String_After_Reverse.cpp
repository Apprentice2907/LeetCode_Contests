...
Reverse "zx" to "xz", so the resulting string is "xzy", which is the lexicographically smallest string achievable.©leetcode
*/
...
// My logic but chatGPT coded and 143ms runtime
